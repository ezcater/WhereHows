...
CREATE TABLE dict_business_metric  (
  ...
  "metric_source"            	VARCHAR(300) COMMENT 'Table Name, Cube Name, URL'  NULL,
  "metric_source_dataset_id"	INT(11) COMMENT 'If metric_source can be matched in dict_dataset' NULL,
  "metric_ref_id_type"       	VARCHAR(50) COMMENT 'DWH, ABTEST, FINANCE, SEGMENT, SALESAPP' NULL,
  "metric_ref_id"            	VARCHAR(100) COMMENT 'ID in the reference system' NULL,
